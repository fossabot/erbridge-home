export const meta = {
  ...
  categories: ['the-island', 'gamedev'],
};

We're making a game!

[Luke Tovee](https://www.luketovee.com/) and I have started working on a
resource management sim, where you play as the leader of a fledgling town of
house boats, moored around a desert island (that doesn't do the concept
justice). We're calling it _The Island_.
