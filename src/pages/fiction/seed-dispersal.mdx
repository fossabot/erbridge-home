import MarkdownPDF from '../../components/MarkdownPDF';

export const meta = {
  title: 'Seed Dispersal',
  categories: ['generative', 'novel'],
  sortOrder: 3,
};
...
<MarkdownPDF
  title="Seed Dispersal"
  src="https://cdn.rawgit.com/erbridge/seed-dispersal/master/dist/seed-dispersal-0.0.2.pdf"
  paperSize="A4"
/>
